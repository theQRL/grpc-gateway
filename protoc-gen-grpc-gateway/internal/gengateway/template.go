...
func typeFromName(name string) string {
	...
	if strings.Contains(lowerName, "epoch") {
		return "github_com_theqrl_qrysm_consensus_types_primitives.Epoch"
	} else if strings.Contains(lowerName, "slot") {
		return "github_com_theqrl_qrysm_consensus_types_primitives.Slot"
	} else if strings.Contains(lowerName, "committee") {
		return "github_com_theqrl_qrysm_consensus_types_primitives.CommitteeIndex"
	} else if strings.Contains(lowerName, "index") {
		return "github_com_theqrl_qrysm_consensus_types_primitives.ValidatorIndex"
	}
	return ""
}
